...
import { r as require$$1 } from "./checkPropTypes-0f5ecd47.js";
import "./react.development-1b0246f4.js";
import { r as require$$0 } from "./index-7f2f3a77.js";
var reactDomServer_browser_development = createCommonjsModule(
  function (module) {
    {
      (function () {
       ...
       */
        ...
        var REACT_PROVIDER_TYPE = hasSymbol
          ...
          : 0xeacd;
        var REACT_CONTEXT_TYPE = hasSymbol ? Symbol.for("react.context")
       ...
       */
        ...
        function createMarkupForProperty(name, value) {
          ...
          if (
            name !== "style" && shouldIgnoreAttribute(name, propertyInfo, false)
          ) {
            return "";
          }
          ...
          if (propertyInfo !== null) {
            ...
            if (
              type === BOOLEAN || type === OVERLOADED_BOOLEAN && value === true
            ) {
            ...
            !!isInHookUserCodeInDev
              ? warning$1(
                ...
                "Do not call Hooks inside useEffect(...), useMemo(...), or other built-in Hooks. " +
                  ...
                  "For more information, see " + "https://fb.me/rules-of-hooks",
              ) : void 0;
          }
          ...
          var propTypes = {
            ...
            checked: function (props, propName, componentName) {
              if (
                ...
                props[propName] == null || enableFlareAPI
              ) {
                return null;
              }
...

        {
          ...
          validateProperty$1 = function (
            ...
            var isReserved = propertyInfo !== null &&
              propertyInfo.type === RESERVED; // Known attributes should match the casing specified in the property config.
        ...
        function warnNoop(publicInstance, callerName) {
          {
            ...
            var componentName = _constructor &&
              getComponentName(_constructor) || "ReactClass";
              ...
              if (typeof inst.componentWillMount === "function") {
                {
                  if (
                    ...
                    var _componentName4 = getComponentName(Component) ||
                      "Unknown";
            ...
            _proto.popProvider = function popProvider(provider) {
              var index = this.contextIndex;
              {
                !(index > -1 && provider === this.contextProviderStack[index])
                  ? warningWithoutStack$1(false, "Unexpected pop.") : void 0;
              }
                ...
                while (out[0].length < bytes) {
                  ...
                  if (suspended || frame.childIndex >= frame.children.length) {
                    ...
                    if (frame.type === "select") {
                      ...
                      frame.type != null && frame.type.type != null &&
              ...
              if (tag === "input") {
                {
                  ...
                  if (
                    ...
                    props.defaultChecked !== undefined && !didWarnDefaultChecked
                  ) {
                    warning$1(
                      false,
                ...
                this.currentSelectValue = props.value != null ? props.value
                : props.defaultValue;
                props = _assign({}, props, {
                  value: undefined,
                });
       ...
       */
        ...
        var ReactDOMServer = ReactDOMServerBrowser$1 && ReactDOMServerBrowser ||
